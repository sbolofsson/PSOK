...
namespace InterLinq.Types.Anonymous
{
    ...
    internal static class AnonymousTypeHelper
    {
        ...
        public static bool IsIGrouping(this Type t)
        {
            ...
            return t.GetInterfaces().Any(interfaceType => interfaceType.IsGenericType && interfaceType.GetGenericTypeDefinition() == typeof (IGrouping<,>));
        }
        ...
        public static bool IsEnumerator(this Type t)
        {
            ...
            return t.GetInterfaces().Any(interfaceType => interfaceType.IsGenericType && interfaceType.GetGenericTypeDefinition() == typeof (IEnumerator<>));
        }
