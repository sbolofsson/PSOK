...
namespace InterLinq.Expressions.Helpers
{
    ...
    public class RewriteExpressionVisitor : ExpressionVisitor
    {
        ...
        protected override object VisitNewExpression(NewExpression expression)
        {
            ...
            return expression.Members == null ? Expression.New(expression.Constructor, VisitCollection<Expression>(expression.Arguments)) : Expression.New(expression.Constructor, VisitCollection<Expression>(expression.Arguments), expression.Members);
